...
for j = 1:2
    ...
    N_R = 2; N_C = 6; i = 1; img_trg = 180;img_trg2 = 215;
    ...
    S = imfilter(Ies,H);
    subplot(N_R , N_C,i),imagesc(S>img_trg2);i = i+1;
    ...
    subplot(N_R , N_C,i),imagesc(Ies>img_trg);i = i+1;
    subplot(N_R , N_C,i),imagesc(Ies>img_trg2);i = i+1;
    S = imfilter(Ies>img_trg,H);
    subplot(N_R , N_C,i),imagesc(S);i = i+1;
